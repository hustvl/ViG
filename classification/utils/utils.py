...
def save_checkpoint_ema(config, epoch, model, max_accuracy, optimizer, lr_scheduler, loss_scaler, logger, model_ema: ModelEma=None, max_accuracy_ema=None, name='ckpt.pth'):
    if 'best' in name:
    ...
    save_path = os.path.join(config.OUTPUT, name)
...
class NativeScalerWithGradNormCount:
    ...
    def __init__(self, use_scale=True):
        self._scaler = torch.cuda.amp.GradScaler(enabled=use_scale)
